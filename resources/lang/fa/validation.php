...
return [
    ...
    */
    ...
    'attributes' => [
        'name' => 'نام',
        'meta_title' => 'متا (meta-title)',
        'meta_description' => 'متا توضیحات (meta-description)',
        'read_time' => 'زمان مطالعه',
        'category_id' => 'دسته بندی',
        'slug' => 'اسلاگ',
        'melicode' => 'کد ملی',
        'acl' => 'دسترسی',
        'insta_id' => 'آیدی اینستاگرام',
        'about_me' => 'درباره من',
        'articles' => 'لیست مقالات',
        'icon' => 'آیکون',
        'birth' => 'تاریخ تولد',
        'title' => 'عنوان',
        'username' => 'نام کاربری',
        ...
        'text' => 'متن',
        'content' => 'محتوا',
        'commentContent' => 'متن نظر',
        'conversationContent' => 'متن پرسش',
        'description' => 'توضیحات',
        'date' => 'تاریخ',
        'time' => 'زمان',
        'available' => 'موجود',
