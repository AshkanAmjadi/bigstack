<div>
    <div onclick="document.querySelector('#deleteComm{{$id}}').classList.toggle('noVisible')" class="relative">
        @component('component.btn.btnD',['title' => 'delete '.$name , 'color'=>'rose'])
            ...
            @endslot
        @endcomponent
        <div id="deleteComm{{$id}}" class="absolute top-1/2 right-1/2 translate-y-1/2- translate-x-1/2 w-full noVisible" wire:click.debounce.200ms="delete">
