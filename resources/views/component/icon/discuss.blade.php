@php($st = isset($strock) ? $strock : '2.5')
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <g fill="none" stroke="currentColor">
        <path stroke-width="{{$st}}"
        ...
        <path stroke-width="{{$st}}"
              ...
              opacity=".5"/>
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="{{$st}}"
              d="M6.518 14h.01m3.481 0h.009m3.482 0h.009" opacity=".5"/>
    </g>
</svg>
