    ...
    <div class="wraper">
        ...
        <div class="pagination-group flex items-center">
            ...
            @if($list->currentPage() != 1)
                <a href="#{{$href}}" wire:click.debounce.150ms="goToPage({{$list->currentPage() - 1}})" rel="nofollow"
            ...
            <div class="pages flex items-center ">
                ...
                @for($i = 6 ; $i >= 1 ; $i --)
                    @if(checkNumber($list->currentPage() - $i))
                        <a href="#{{$href}}" wire:click.debounce.150ms="goToPage({{$list->currentPage() - $i}})" rel="nofollow"
                ...
                <a href="#{{$href}}" rel="nofollow"
                   class="page-btn-active shadow-md shadow-blue-200 dark:shadow-blue-500/60 hover:shadow-lg hover:shadow-blue-200 dark:hover:shadow-blue-700 bg-blue-500 dark:bg-blue-500 text-slate-50 hover:bg-blue-400">{{$list->currentPage()}}</a>
            ...
            @if($list->hasMorePages())
                <a href="#{{$href}}" rel="nofollow" wire:click.debounce.150ms="goToPage({{$list->currentPage() + 1}})" class="next-pagination page-btn mx-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
