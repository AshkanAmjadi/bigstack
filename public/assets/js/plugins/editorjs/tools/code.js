 ...
 * Original file: /npm/@editorjs/code@2.8.0/dist/bundle.js
 *
    ...
    return function (e) {
        ...
        function s(e, t) {
            for (var n = {}, r = [], o = 0; o < e.length; o++) {
                ...
                n[s] = u + 1;
                var d = c(l), f = {css: a[1], media: a[2], sourceMap: a[3]};
         ...
         */var a = function () {
            function e(t) {
                ...
                !function (e, t) {
                    ...
                    holder: null,
                    textarea: null
                }, this.data = {code: n.code || ""}, this.nodes.holder = this.drawView()
            }
            ...
            return o(e, null, [{
                ...
                key: "onPaste", value: function (e) {
                    var t = e.detail.data;
                    this.data = {code: t.textContent}
                }
            }, {
                key: "tabHandler", value: function (e) {
