<article class="w-full grid grid-cols-2 card_c p-3">
    ...
    @endphp
    <div class="left py-3 pr-2 pl-2 flex flex-col justify-around gap-2">
        <a target="_blank" href="{{route('article.show',['article'=>$subject->slug])}}" class="text-mid font-bold">
            <h3>
                {{$subject->title}}
            </h3>
        </a>
        ...
        <p class="text-fsm font-light pr-2 line-clamp-3">
