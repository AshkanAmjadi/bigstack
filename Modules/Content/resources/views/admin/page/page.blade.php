...
@section('content')
    ...
    <div id="content" class="mini w-full pt-16 text-slate-700 pb-6 overflow-x-clip">
        ...
        <div id="contentWraper" class="w-11/12 mx-auto mt-16 lg:w-96p sm:w-full space-y-6">
            ...
            @include('content::admin.page.action')
                            ...
                            <td>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @component('component.badg.badg' ,['color' => 'sky'])
                                        @slot('title')
                                            تعداد بازدید : {{$subject->view}}
                                        @endslot
                                    @endcomponent

                                    @component('component.btn.btnD',['title' => 'اشتراک گذاری','size' => 'fsm'])
                                        @slot('action')
                                            onclick="copyUrl('shareLink{{$subject->id}}')"
                                        @endslot
                                        @slot('icon')
                                ...
                                <input id="shareLink{{$subject->id}}" type="text" class="hidden"
                                       value="{{route('page.show',['page'=>$subject->slug])}}">
