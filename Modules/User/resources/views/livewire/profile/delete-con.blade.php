<div>
    <div onclick="document.querySelector('#deleteCon{{$id}}').classList.toggle('noVisible')" class="relative">
        @component('component.btn.btnD',['title' => 'Delete '.$name , 'color'=>'rose'])
            ...
            @endslot
        @endcomponent
        <div id="deleteCon{{$id}}" class="absolute top-1/2 right-1/2 translate-y-1/2- translate-x-1/2 w-full noVisible" wire:click.debounce.100ms="delete">
